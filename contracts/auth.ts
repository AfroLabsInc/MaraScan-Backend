...
declare module '@ioc:Adonis/Addons/Auth' {
  ...
  interface ProvidersList {
    ...
    */
    ...
    beneficiary: {
      ...
      config: LucidProviderConfig<typeof Beneficiary>
    }
  }
  ...
  */
  interface GuardsList {
    ...
    */
    adminApi: {
      implementation: OATGuardContract<'admin', 'adminApi'>
    ...
    beneficiaryApi: {
      ...
      config: OATGuardConfig<'beneficiary'>
      client: OATClientContract<'beneficiary'>
    }
  }
}
