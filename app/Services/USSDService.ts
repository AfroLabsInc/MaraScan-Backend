...
const content = {
  ...
  maa: {
    welcomeMsg: 'Kitomoni te MaraScan. Tawalu tenaa',
    welcomeBack: 'kitomoni agi',
    register: 'Enkigeroto',
    manageAcc: 'Olshumati Lai',
    changeLang: 'Ekibelekenyata ororei',
    support: 'Eretoto',
    selectLang: 'Tengelu ororei.or olomonI, Tawalu tenaa',
    firstName: 'Ingero enkarna ino edukuya',
    lastName: 'Ingero enkarna ino nabayie',
    country: 'Ingero enkop inyi.',
    region: 'Ingero olkereti emurua',
    address: 'Ingero ilkingerot lo saduku Le posta',
    kId: 'Tisira  inambari inonok enkipande',
    selectConservancy: 'Select Your Conservancy, Reply with:',
    titleDeedId: 'tisira inambari we olshamba lino',
    skill: 'Enter your Skill',
    formComplete: 'Ashe ama idipa amputa embalai, Entabai',
    confirmReg: 'Tujuro ilkingerot lino',
    cancelReg: 'Tujuto olkingeroto lino.',
    registerDone:
      "Inyuaat oo ntokiting inonok naariwayioki na kitodoluni toloing'angi lang ewalata ",
    registerCancel:
      'kiwomonu empalikino eitu idimayu pee kipuo dukuyaa too sirat Le mpalai ino. ekishukokino iyie aigil',
    manageAccMenu: "kainyoo iyieu ning'uraa?",
    accBal: 'esiana olchumati lino',
    transferMoney: 'Terewa iropiyiani.',
    withdrawToMpesa: 'Intayu te M-pesa',
    amountToWithdraw: 'Enter Amount To Withdraw',
    withrawMessage1: 'intayu katukul',
    withrawMessage2: 'pii',
    withrawMessage3: 'eloito dukuyaa',
    viewHistory: 'todolu eretoto enkatini ',
    accBalRes: 'kaja esiana olchumati lino',
    setPasswordMenu: 'intabira enamba esiri',
    confirmPasswordMenu: 'tujuro enamba ino esiri aigil',
    passwordSetSuccessful: 'etudupe enamba ino esiri',
    passwordSetFailed: 'etanya enamba ino esiri, menarikino enamba ino esiri naa tujuro aitoki.',
    enterPassword: "ing'urai enamba ino esiri",
    incorrectPassword: "mesipa enamba esiri,ingila ing'urai.",
  },
  swahili: {
